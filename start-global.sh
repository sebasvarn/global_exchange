...
echo "====================================================" | tee -a "$LOGFILE"
echo "[ $DATE ] 🚀 Iniciando despliegue automático" | tee -a "$LOGFILE"
echo "====================================================" | tee -a "$LOGFILE"
...
check_file "$PROJECT_ROOT/app/Dockerfile.dev"
check_file "$PROJECT_ROOT/app/.env.dev"
check_file "$PROJECT_ROOT/sql-proxy01/.env.test"
...
# ============================================================================
echo "====================================================" | tee -a "$LOGFILE"
echo "🎉 DEPLOYMENT COMPLETADO CON ÉXITO" | tee -a "$LOGFILE"
echo "===================================================="
